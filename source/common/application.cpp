...
// @param run_for_frames: Number of frames to run before closing the application.
// if run_for_frames == 0, the application runs indefinitely till manually closed.
int our::Application::run(int run_for_frames) {
    ...
    io.Fonts->AddFontFromFileTTF("assets/fonts/EvilEmpire-4BBVK.ttf", 16.0f);
//    ImFont *font2 = io.Fonts->AddFontFromFileTTF("assets/fonts/DragonHunter-9Ynxj.otf", 16.0f);
