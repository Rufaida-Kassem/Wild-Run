...
namespace our {
    ...
    public:
        ...
        ShaderProgram& operator=(const ShaderProgram&) = delete; //Assignment operator
        //Question: Why do we delete the copy constructor and assignment operator?
        //Answer: As this will copy the program handle, which is not what we want. We want to copy the shader program itself, not the handle.        
